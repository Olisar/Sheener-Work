...
<head>
    ...
    <style>
        /* Prevent scrollbar on homepage - no scrolling at all */
        html.homepage,
        body.homepage {
        ...
        /* Ensure logo and beta are side by side and vertically aligned */
        .logo-section .logo1 {
            margin-bottom: 0;
            display: flex;
            align-items: center;
        ...
        .feature-card {
            ...
            animation: slideUpFromBottom 0.575s ease-out forwards;
        ...
        .feature-card:hover {
            transform: translateY(-20px) scale(1.3) rotate(0deg) !important;
            background: rgba(255, 255, 255, 0.2) !important;
            box-shadow: 0 20px 50px rgba(0, 0, 0, 0.5),
                0 0 30px rgba(54, 133, 254, 0.4),
                0 0 60px rgba(0, 198, 255, 0.2) !important;
            border-color: rgba(54, 133, 254, 0.6) !important;
            z-index: 10;
        }
        ...
        /* Ensure Event Category and Subcategory labels match Location label height (2 lines) */
        .event-modal-body label[for="anon_primaryCategory"],
        .event-modal-body label[for="anon_secondaryCategory"] {
            min-height: 2.8em;
            line-height: 1.4em;
        }
        ...
        .limit-text {
            /* Layout */
            display: inline;
            /* Keeps the text on the same line as the label */
            margin-left: 8px;
            /* Adds a small space for separation */

            /* Appearance: Applying your required color and a different font */
            color: #666;
            /* This is the specified dark grey color */
            font-size: 0.85em;
            /* Makes the text slightly smaller than the main label */
            font-family: monospace;
            /* Example of a "different font" for distinction */
        }
    </style>
</head>
    ...
    <header>
        <div class="header-content">
            ...
            <div class="header-left-section">
                <img src="img/Amneal Logo new y.png" alt="Amneal Logo" class="side-logo">
            </div>

            <div class="logo-section">
                <div class="logo1">Sheener<span class="dot">.</span></div>
                <span class="head-beta">BETA</span>
            </div>

            <div class="header-actions">
                <button type="button" class="premium-login-btn"
    ...
    <main>
        ...
        <section class="hero">
            ...
            <div id="qrCodeSection"
                style="margin: 2rem auto; max-width: 900px; opacity: 0; animation: fadeInUp 1.8s ease-out forwards;">
                <div
                    style="background: rgba(255, 255, 255, 0.15); backdrop-filter: blur(10px); border-radius: 16px; padding: 30px; display: flex; gap: 40px; align-items: center; border: 1px solid rgba(255, 255, 255, 0.2); flex-wrap: wrap; justify-content: center;">
                    <!-- Left Side: QR Code with Hover Tooltip -->
                    <div style="text-align: center; flex-shrink: 0; position: relative;">
                        <div id="qrCodeWrapper" style="position: relative; display: inline-block;">
                            <canvas id="qrCodeCanvas"
                                style="background: white; padding: 10px; border-radius: 8px; max-width: 200px; max-height: 200px; display: block; cursor: pointer; transition: transform 0.3s ease;"></canvas>
                            <!-- Hover Tooltip - Left Side -->
                            <div id="qrTooltip"
                                style="position: absolute; right: 100%; top: 50%; transform: translateY(-50%) translateX(-15px); background: rgba(0, 0, 0, 0.9); color: white; padding: 15px 20px; border-radius: 12px; min-width: 280px; max-width: 320px; opacity: 0; visibility: hidden; transition: all 0.3s ease; pointer-events: none; z-index: 1000; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3); margin-right: 10px;">
                                <h4
                                    style="color: white; font-size: 1rem; font-weight: 600; margin-bottom: 12px; line-height: 1.4; border-bottom: 1px solid rgba(255, 255, 255, 0.2); padding-bottom: 8px;">
                                    <i class="fas fa-mobile-alt" style="margin-right: 8px;"></i>Scan to Install
                                    Mobile
                                    App
                                </h4>
                                <p
                                    style="color: rgba(255, 255, 255, 0.95); font-size: 0.9rem; line-height: 1.6; margin-bottom: 12px;">
                                    Use your mobile device to scan this QR code and install the reporting app. The
                                    app
                                    works completely offline and automatically syncs your reports when you reconnect
                                    to
                                    the network.
                                </p>
                                <div
                                    style="background: rgba(255, 255, 255, 0.1); padding: 10px; border-radius: 6px; margin-top: 10px;">
                                    <p
                                        style="color: rgba(255, 255, 255, 0.9); font-size: 0.85rem; margin: 0; line-height: 1.6;">
                                        <i class="fas fa-wifi"
                                            style="margin-right: 6px; color: #4CAF50;"></i><strong>Works
                                            Offline:</strong> Save events on your phone<br>
                                        <i class="fas fa-sync-alt"
                                            style="margin-right: 6px; color: #2196F3;"></i><strong>Auto
                                            Sync:</strong>
                                        Uploads when connected<br>
                                        <i class="fas fa-network-wired"
                                            style="margin-right: 6px; color: #FF9800;"></i><strong>Network:</strong>
                                        172.21.10.99
                                    </p>
                                </div>
                                <!-- Tooltip Arrow - Points Right -->
                                <div
                                    style="position: absolute; left: 100%; top: 50%; transform: translateY(-50%); width: 0; height: 0; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-left: 8px solid rgba(0, 0, 0, 0.9);">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qr-text-content" style="flex: 1; min-width: 300px; color: white;">
                        <h2
                            style="color: white; font-size: clamp(2rem, 4vw, 3.5rem); font-weight: 700; margin-bottom: 1rem; line-height: 1.2;">
                            EHS Management System
                        </h2>
                        <p
                            style="color: rgba(255, 255, 255, 0.95); font-size: clamp(0.95rem, 1.8vw, 1.2rem); line-height: 1.6; font-weight: 300;">
                            Comprehensive risk assessment, monitoring, and control management<br>
                            for pharmaceutical manufacturing operations
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Comprehensive risk identification and evaluation tools for proactive management</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Track and monitor risks in real-time with intuitive dashboards and analytics</p>
                </div>
                <div class="feature-card incident-card" onclick="openEventModal()">
                    <div class="feature-icon">
                        <i class="fas fa-exclamation-triangle" style="color: #e74c3c;"></i>
                    </div>
                    <h3>Incident/Observation Report</h3>
                    <p>Report safety incidents, near misses, and observations - no login required</p>
                </div>
                <div class="feature-card"
                    onclick="window.location.href='http://172.21.10.99/sheener/trainingIndex.html'">
                    <div class="feature-icon">
                        <i class="fas fa-graduation-cap"></i>
                    </div>
                    <h3>Training & Development</h3>
                    <p>Access comprehensive training materials and track employee development</p>
                </div>
            </div>
        </section>
        ...
        <div id="reportEventBox" class="event-modal-overlay" onclick="closeEventModal(event)">
            <div class="event-modal" onclick="event.stopPropagation()">
                <div class="event-modal-header">
                    <h3><i class="fas fa-exclamation-triangle" style="margin-right: 8px; color: #e74c3c;"></i>Report an
                        Issue (No Login Required)</h3>
                ...
                <div class="event-modal-body">
                    <form id="anonymousEventForm" enctype="multipart/form-data">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
                            <div>
                                <label for="anon_location" class="required"><i class="fas fa-map-marker-alt"
                                        style="margin-right: 6px;"></i>Location of Event / Observation /
                                    Comment:</label>
                        ...
                        <div>
                            <label for="anon_attachments">
                                <i class="fas fa-paperclip" style="margin-right: 6px;"></i>
                                Attachments (optional):
                                <small class="limit-text">Max 5MB per file, max 10 files</small>
                            </label>
                            <input type="file" id="anon_attachments" name="attachments[]" multiple
                ...
                <div class="event-modal-footer">
                    <button type="button" class="cta-button" id="generatePdfBtn"
                        style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%);">
                        <i class="fas fa-file-pdf" style="margin-right: 8px;"></i>Generate & Download PDF
                    </button>
                    ...
                    <button type="button" class="close-button" onclick="closeEventModal()">
    ...
    <script>
        ...
        function acquireGPSLocation() {
            ...
            if ("geolocation" in navigator) {
                locationStatus.innerHTML = '<i class="fas fa-spinner fa-spin" style="margin-right: 6px;"></i>Acquiring GPS location...';
                ...
                navigator.geolocation.getCurrentPosition(
                    function (position) {
                        ...
                        locationStatus.innerHTML = '<i class="fas fa-check-circle" style="margin-right: 6px;"></i>Location locked: ' +
                    ...
                    function (error) {
                        ...
                        locationStatus.innerHTML = '<i class="fas fa-exclamation-triangle" style="margin-right: 6px;"></i>' + errorMsg;
                ...
                locationStatus.innerHTML = '<i class="fas fa-times-circle" style="margin-right: 6px;"></i>Geolocation not supported by this browser.';
                locationStatus.style.color = '#e74c3c';
            }
        }
